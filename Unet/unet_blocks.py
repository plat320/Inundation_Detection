...
#=========only temporal 3D================================================================================================
class First3Dtemporal(nn.Module):
    def __init__(self, in_channels, middle_channels, out_channels, dropout=False):
        super(First3Dtemporal, self).__init__()

        layers = [
            nn.Conv3d(in_channels, middle_channels, kernel_size=(3,1,1), padding=(1,0,0)),
            nn.BatchNorm3d(middle_channels),
            nn.ReLU(inplace=True),
            nn.Conv3d(middle_channels, out_channels, kernel_size=(3,1,1), padding=(1,0,0)),
            nn.BatchNorm3d(out_channels),
            nn.ReLU(inplace=True)
        ]
...
class Encoder3Dtemporal(nn.Module):
    def __init__(
            self, in_channels, middle_channels, out_channels,
            dropout=False
    ):
        super(Encoder3Dtemporal, self).__init__()
...
class Center3Dtemporal(nn.Module):
    def __init__(self, in_channels, middle_channels, out_channels, deconv_channels, dropout=False):
        super(Center3Dtemporal, self).__init__()
        ...
        layers = [
            ...
            nn.BatchNorm3d(out_channels),
            nn.ReLU(inplace=True),
            nn.ConvTranspose3d(out_channels, deconv_channels, kernel_size=(2,1,1), stride=(2,1,1))
        ]
...
class Decoder3Dtemporal(nn.Module):
    def __init__(self, in_channels, middle_channels, out_channels, deconv_channels, dropout=False):
        super(Decoder3Dtemporal, self).__init__()
...
class Last3Dtemporal(nn.Module):
    def __init__(self, in_channels, middle_channels, out_channels):
        super(Last3Dtemporal, self).__init__()

        layers = [
            nn.Conv3d(in_channels, middle_channels, kernel_size=(3,1,1), padding=(1,0,0)),
            nn.BatchNorm3d(middle_channels),
            nn.ReLU(inplace=True),
            nn.Conv3d(middle_channels, middle_channels, kernel_size=(3,1,1), padding=(1,0,0)),
            nn.BatchNorm3d(middle_channels),
            nn.ReLU(inplace=True),
            nn.Conv3d(middle_channels, out_channels, kernel_size=1),
            nn.Softmax(dim=1)
