...
import os
from default_set.vnet import *
from temporal_ex.vnet_train_val import train_vnet
...
set_wt_save_name = 'vnet_diceL1_fullsz_test_191112_1'
...
print("-"*20)
print("Create model")
model= VNet(elu=True, nll=False, frm_ch=frm_ch_num, height=data_height, width=data_width)
weight_decay = 1e-4
start_epoch = 0
best_mIoU = 0.0
...
print("="*30)
print("Start train")
train_vnet(model,optimizer,scheduler,trainloader,valloader,
